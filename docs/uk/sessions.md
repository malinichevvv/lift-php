...
> **Починаючи з 1.3.0:** десеріалізація об’єктів вимкнена за замовчуванням (`allowedClasses: false`). Це не дає підробленим або застарілим payload'ам сесії інстанціювати класи застосунку.

- ❌ Не серіалізуйте об’єкти із секретами в сесію — передайте білий список дозволених класів або зберігайте лише ідентифікатори:
  ```php
  new Session($store);                                // об’єктів немає за замовчуванням
